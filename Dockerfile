...
RUN ["/bin/sh", "-c", "debconf-set-selections", "<<<", "mysql-community-server mysql-community-server/data-dir select ''"]
RUN ["/bin/sh", "-c", "debconf-set-selections", "<<<", "mysql-community-server mysql-community-server/root-pass password 123123"]
RUN ["/bin/sh", "-c", "debconf-set-selections", "<<<", "mysql-community-server mysql-community-server/re-root-pass password 123123"]
